...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-black font-outfit text-white selection:bg-amber-500 selection:text-black flex flex-col">
      ...
      {/* Kita ganti efek Blur berat dengan Gradient statis yang ringan */}
      ...
      <div className="relative z-10 flex-grow flex flex-col items-center justify-center px-4 text-center pt-32 pb-10">
        ...
        <h1 className="text-5xl md:text-8xl font-bold mb-6 font-cinzel tracking-tight relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl z-10 mb-20 animate-in fade-in zoom-in duration-1000 delay-300">
            ...
            {/* KARTU TIKTOK */}
            <a href="https://tiktok.guidify.app" className="group relative bg-[#111] border border-white/10 rounded-3xl p-8 hover:border-amber-500 transition-colors duration-300">
                ...
                <p className="text-gray-500 text-sm">Download video tanpa watermark & audio MP3.</p>
            ...
            {/* KARTU INSTAGRAM */}
            <a href="https://insta.guidify.app" className="group relative bg-[#111] border border-white/10 rounded-3xl p-8 hover:border-pink-500 transition-colors duration-300">
                <div className="w-16 h-16 bg-black border border-white/20 rounded-2xl flex items-center justify-center mb-6 text-3xl group-hover:scale-105 transition-transform">
                    📸
                </div>
            ...
            {/* KARTU YOUTUBE */}
            <a href="https://youtube.guidify.app" className="group relative bg-[#111] border border-white/10 rounded-3xl p-8 hover:border-red-500 transition-colors duration-300">
                <div className="w-16 h-16 bg-black border border-white/20 rounded-2xl flex items-center justify-center mb-6 text-3xl group-hover:scale-105 transition-transform">
                    ▶️
                </div>
